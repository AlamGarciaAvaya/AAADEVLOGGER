...
function actualizarRegistro() {
            ...
            for (let i = 0; i <= Object.keys(myObj).length - 1; i++) {
                ...
                for (let j = 1; j <= 5; j++) {
                    ...
                    if (j === 1) {
                        ...
                        xhr.open("GET", absolutepath+"GetFileCreation?archivo=RecordParticipant&nombreWav=" + (myObj["Index " + i + ""]));
                    ...
                    if (j === 4) {
                        ...
                        console.log(wav2);
                        xhr.open("GET", absolutepath + "GetBase64?audio=" + wav2 + "&archivo=RecordParticipant");
                        xhr.send(data);
    ...
    xhr.open("GET", absolutepath + "Archivos/web/RecordParticipant/");
...
function copyPath() {
    ...
    el.value = absolutepath+"FileSaveServlet/web/RecordParticipant/" + tds;
